...
###2. DELETE /api/ufops/:id(删除一个Ufop)
...
```js
{
   ...
   {  
      ...
      "createTime": "1970-01-01 08:00:00 +0800 CST"
      "instanceNum":	4"
      "maxInstanceNum": "5"
      "flavor": "default"
      "accessList": "1380469902"
   }
```
...
###5. POST /api/images(上传一个Ufop Image)
...
###6. GET /api/ufops/:id/versions(获取一个ufop的版本列表)
...
###7. GET /api/ufops/:id/instances(获取一个ufop的实例列表)
...
###8. POST /api/ufops/:id/instances/:id/start(启用一个ufop实例)
...
###9. POST /api/ufops/:id/instances/:id/stop(停用一个ufop实例)
...
###10. POST /api/ufops/:id/instances/:id/reboot(重启某一实例号的ufop实例)
...
###11. POST /api/ufops/:id/instances(添加ufop实例)
...
##12. DELETE /api/ufops/:id/instances/:id(删除某一实例号的ufop实例)
...
###13. POST /api/ufops/:id/instances/:id/switch(切换到当前ufop实例)
...
###14. GET /api/ufops/:id/instances/:id/log(查看某一个运行的ufop实例的日志)
